...
Słownik angielsko<->rosyjski dla dictd kodowany w koi8-r. Uruchom
serwer z opcją --locale ru_RU.KOI8-R, żeby móc go używać.
...
Słownik angielsko-rosyjski dla dictd kodowany w koi8-r.
...
Słownik rosyjsko-angielski dla dictd kodowany w koi8-r. Uruchom serwer
